...
params:
  ...
  db: "/Volumes/LEEF/0.TOC/LEEF-1/LEEF.RRD.sqlite"
  LEEF: LEEF_1
  min_TC: 5
  min_IC: 0.3
---
...
#| label: setup
if (!exists("params")){
   params <- rmarkdown::yaml_front_matter('~/Documents_Local/git/LEEF/measurements/LEEF.measurement.toc/inst/Import and filter TOC.qmd')$params
}
