...
conc_ext <- function(c1, c2, c3, cv, max_cv){
  ...
  CHECK AND CHANGE TO USE MIN OF ALL TREE CV!!!
  ...
  conc[which(conc_13) ] <- rowMeans(data.frame(c1[which(conc_13)],  c3[which(conc_13) ]))
  conc[which(conc_23) ] <- rowMeans(data.frame(c2[which(conc_23)],  c3[which(conc_23) ]))
